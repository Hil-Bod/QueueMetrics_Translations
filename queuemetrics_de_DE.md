...
General information about this language pack. The language name should be
written in the language itself, and will appear in the drop-down language
selector.
...
td_agstatus_agent_is_currently_logged_on_some_queues=Agent ist im Moment in Warteschlange eingeloggt
...
td_ancod_answered_calls_sla=Angenommene Anrufe: Level
...
td_cko_agent_dump=Ende durch Agenten
td_cko_caller_abandon=Abbruch durch Anrufer
td_cko_channel=Kanal
td_cko_dumped=Verworfen
td_cko_empty=Leer
td_cko_exit_empty=Abbruch bei leerer Warteschlange
...
td_knumbers_blacklist=Sperrliste
td_knumbers_none=Keine
td_knumbers_vip=VIP-Anrufer
td_nodupnum_allow_duplicate_numbers=doppelte Nummern erlaubt
td_nodupnum_no_duplicate_numbers=doppelte Nummern verboten
...
aout_avg_talk_time=Durchschn. Gesprächszeit
...
aout_call_res_by_tag=Anrufergebnisse pro Tag
aout_calltag=Tag
aout_case_distribution=Zuteilung der Anfrage
aout_chart=~
aout_client_distribution=Zuteilung des Kunden
aout_contacts_n=Kontakte
aout_convratio=Konversionsrate
aout_cph=KPS
aout_fcr_avg_duration=Durchschnitt. Dauer
aout_fcr_caller_avg_calls=Durchschnitt. Anrufe pro Anrufer-Id
...
clage_answered_calls_by_custom_group=Angenommene Anrufe nach nutzerdefinierter Gruppe
...
clage_sales=Verkauf
clage_salesph=S PH
clage_session_and_pause_durations=Sitzungs- und Pausendauer
...
custrep_custom_report_analysis=Nutzerdef. Bericht
...
custrep_run_custom_report=Ntzerdef. Bericht erstellen
custrep_server=Server
custrep_shortcall_attempts=Kurzer Versuch Wartefrist
...
clko_calls_fully_within_the_given_time_interval=Nicht angenommene Anrufe innerhalb der vorgegebenen ZeitIntervall
clko_cause=Grund
clko_chart=Grafik
clko_delta=Delta
clko_detail=Details
...
clko_unans_nums_recalled=Nummer zurückgerufen
...
clhdr_callfeaturecode=Gefiltert nach Rufnummerncode:
...
evt_blind_transfer=Weiterleitung ohne Rückfrage
...
hdr_customblocks=Nutzerdef. Datensatz
hdr_customreports=Nutzerdef. Bericht
...
edit_items_data_blocks=Datensatz
...
edit_record_agawqueue_qsettings=Warteschlangen-Einstellungen
edit_record_agawqueue_qualconversions=Qualifizierte Gespräche%
...
filter_ivr=IVR
filter_lostAttemptFor= Fehlversuche für
...
rt3_kiosk_mode_warning=Sie befinden sich derzeit im Kioskmodus!Die Bearbeitung der Wallboards ist deaktiviert.
...
rt3_private=Private Wallboards
rt3_public=Öffentliche Wallboards
rt3_purple=lila
rt3_qcont=QC
rt3_qcontph=QCPH
...
rt3_select_wallboard=Wählen Sie eine Wallboards
rt3_send_command=Ok
...
rt3_waiting=Warten
rt3_wallboard_num=Konfiguration der Wallboards
rt3_wallboard_saved=Wallboards gespeichert
rt3_widget=Widget
...
fp_known_numbers_edit=Bekannte Nummern
fp_last=Letzte
...
fp_wallboard=Wallboards starten
...
propedit_category_synchronizer=Synchronisierer
...
propedit_feature_wallboard=Wallboards
...
propedit_key_blindxfer=Funktionscode "Weiterleitung ohne Rückfrage"
...
propedit_key_default_areacode_digits_desc=Anzahl der Ziffern als Standard-Vorwahl berücksichtigt werden sollen
...
propedit_option_spy=Spionieren
...
keydesc_wallboard_add=Nutzer kann Wallboards anlegen und editieren
keydesc_wallboard_forall=Nutzer kann öffentliche Wallboards speichern
...
➡️ phone_blind=Weiterleitung ohne Rückfrage
phone_blind_transfer=Weiterleitung ohne Rückfrage
# 🔴 phone_call -> Call
➡️ phone_call=Anruf
...
home_dbtest_configuration=Ansicht DB
home_dbtest_db_inspector=Ansicht CFG
home_dbtest_ram_cache=RAM-Cache
home_dbtest_smtp=SMTP-Tester
home_diagnostics_title=Diagnose
...
home_news_subtitle=QueueMetrics Neueste Info
...
home_realtime_subtitle=Übersicht der Live-Anrufe
home_realtime_title=Echtzeit
home_reports_subtitle=Report-Historie
...
➡️ cfgprops_n_items=N. Properties gefunden
# 🔴 cfgprops_input -> Enter one or more properties to set, one per line
➡️ cfgprops_input=Eingabe von einem oder mehr Properties, eins pro Zeile
# 🔴 cfgprops_comment -> Reason for this change
➡️ cfgprops_comment=Grund zur Änderung
# 🔴 cfgprops_sort_by -> Sort by
➡️ cfgprops_sort_by=Sortieren nach
...
➡️ cfgprops_col_value=akteller Wert
# 🔴 cfgprops_col_comment -> Reason
➡️ cfgprops_col_comment=Ursache
...
➡️ cfgprops_history_previous=vorheriger Eintrag
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
➡️ ccase_client_xref=
cdp_clonedispositions=Regeln für die Löschen von Klonen
...
dlr_list_state= Auflistung Status
...
prl_invalid_pause=Die Pause ist in der Datenbank nicht angelegt. Es ist unmöglich, sie zu ändern.
prl_invalid_session=Die Sitzung ist in der Datenbank nicht angelegt. Es ist unmöglich, sie zu ändern.
...
qap_amo_queue= Warteschlangen-Name
...
reports_filter_calltags=Kennzeichen aufrufen
...
reports_page_visibilitykey=Visibilityschlüssel
...
reports_visibilitykey=Visibility-Schlüssel
...
rt_agents_currently_logged_in=derzeit eingeloggte Agenten:
rt_agg_by_queue_view=Zusammengefasst nach Warteschlangen-Ansicht
rt_agg_by_tag_view=Zusammengefasst nach Kennzeichen-Ansicht
rt_alarms=Alarme
...
rt_exception_noagents=Der aktuelle Benutzer betreut keine Agenten.
...
rt_pop_please_enter_your_local_or_remote_extension=Bitte Eingabe der lokale oder remote Nebenstellennummer, um Anrufüberwachung zu starten.
...
rt_qacall=QA
rt_qacall_tt=QA
rt_queue_and_tags_view=Ansicht Warteschlangen und Kennzeichen:
...
rt_short_queue_and_tags_view=Warteschlangen und Kennzeichen
rt_short_queue_and_times_view=Warteschlangen und Zeiten
rt_short_reload=Neu laden
rt_short_rt_agg_by_tag_view=Nach Kennzeichen Ansicht
...
savedq_seqKey=Visibility-Schlüssel:
savedq_type=Typ
